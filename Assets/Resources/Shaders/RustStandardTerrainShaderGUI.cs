...
public class RustStandardTerrainShaderGUI : ShaderGUI
{
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
		...
		MaterialProperty _LandMask = FindProperty("_LandMask", properties); // Add LandMask property
        ...
        if (showRendering)
        {
            ...
            materialEditor.FloatProperty(_BiomeMode, "Biome Rendering Mode");
            materialEditor.FloatProperty(_TopologyMode, "Topology Rendering Mode");
            materialEditor.FloatProperty(_PreviewMode, "Preview Mode"); 
			materialEditor.FloatProperty(_LandMask, "Land Mask");
